...
},e.C_BLOCK_COMMENT_MODE,t,e.HASH_COMMENT_MODE]}}}());hljs.registerLanguage("php",function(){"use strict";return function(e){var r={
...
relevance:0}},{begin:"\\n\\n",starts:{subLanguage:[],endsWithParent:!0}}]}}}());hljs.registerLanguage("dos",function(){"use strict";return function(e){
...
className:"number",begin:"\\b\\d+",relevance:0},t]}}}());hljs.registerLanguage("vbscript",function(){"use strict";return function(e){
...
}),e.COMMENT(/'/,/$/,{relevance:0}),e.C_NUMBER_MODE]}}}());hljs.registerLanguage("xml",function(){"use strict";return function(e){var n={
